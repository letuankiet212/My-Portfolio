    ...
    <div class="d-flex align-items-center">
      <div class="file-actions">
        ...
        <svg
          ...
          stroke-linecap="round"
          stroke-linejoin="round"
          class="feather feather-trash font-medium-2 cursor-pointer d-sm-inline-block d-none me-50"
        >
        ...
        <svg
          ...
          stroke-linecap="round"
          stroke-linejoin="round"
          class="feather feather-alert-circle font-medium-2 cursor-pointer d-sm-inline-block d-none"
        ...
        <div class="dropdown d-inline-block">
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="feather feather-more-vertical font-medium-2 cursor-pointer"
            role="button"
            id="fileActions"
          ...
          <div class="dropdown-menu dropdown-menu-end" aria-labelledby="fileActions">
            <a class="dropdown-item" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-move cursor-pointer me-50"
              >
            ...
            >
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-alert-circle cursor-pointer me-50"
              >
                <circle cx="12" cy="12" r="10"></circle>
                <line x1="12" y1="8" x2="12" y2="12"></line>
                <line x1="12" y1="16" x2="12.01" y2="16"></line>
            ...
            <a class="dropdown-item d-sm-none d-block" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-trash cursor-pointer me-50"
              >
                <polyline points="3 6 5 6 21 6"></polyline>
                <path
                  d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"
            ...
            <a class="dropdown-item" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-plus cursor-pointer me-50"
              >
            ...
            <a class="dropdown-item" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-folder-plus cursor-pointer me-50"
              >
                <path
            ...
            <a class="dropdown-item" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-star cursor-pointer me-50"
              >
                <polygon
            ...
            <a class="dropdown-item" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-droplet cursor-pointer me-50"
              >
            ...
            <a class="dropdown-item" href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-download cursor-pointer me-50"
              >
